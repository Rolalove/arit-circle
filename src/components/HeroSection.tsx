...
export const HeroSection = () => {
  return (
    <section className="relative mt-40 lg:mt-20 w-full px-6 lg:px-0 lg:px-0 ">
      ...
      <div className="absolute inset-0 lg:-mt-12  bg-[url('/TheCircle.png')]  bg-no-repeat bg-center mx-auto bg-auto w-full lg:w-full lg:bg-cover h-[100vh] min-h-[55rem]  -z-10"></div>
    </section>
  );
};
